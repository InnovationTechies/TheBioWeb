...
namespace TheBiometricWeb.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            ViewBag.EmpType = new SelectList(db.EmpTypes, "Em_TypeID", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EmpID,FirstName,LastName,Email,Pin,FingerPrint,CellNumber,Region,ID_No,EmpType,EmpImage,Present")] Employee employee)
        {
